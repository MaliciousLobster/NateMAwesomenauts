...
var game = {
	...
	if (!me.video.init("screen",  me.video.CANVAS, 1067, 600, true, '1.0')) { //sets screen dimensions
	...
	me.state.SPENDEXP = 112; //112 represents the screen for SPENDEXP
	me.state.LOAD = 113;
	me.state.NEW = 114;
	...
	"loaded" : function () {
		...
		me.pool.register("PayerCreep", game.PlayerCreep, true);
